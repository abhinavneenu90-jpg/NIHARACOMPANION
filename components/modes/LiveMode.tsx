...
const LiveMode: React.FC<LiveModeProps> = ({ userName, voiceTone, onInteraction, isPro }) => {
    ...
    const startConversation = async () => {
        ...
        // The `ai` instance is imported from the central service.
        // If the API key was not available during initialization, `ai` will be null.
        if (!ai) {
            setStatus("API Key not configured. See console.");
            console.error("Gemini API key is not available. Live mode cannot start.");
            return;
        }
